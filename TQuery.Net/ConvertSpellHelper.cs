...
{
    public class ConvertSpellHelper
    {
        /// <summary>
        /// 定义拼音区编码数组
        /// </summary>
        ...
        public static string Convert(string hzString, int maxLength)
        {
            ...
            hzString = hzString.Replace("{", "").Replace("}", "").Replace("^", "").Replace("&", "").Replace("=", "").Replace("~", "").Replace("@", "").Replace("￥", "").Replace("：", "").Replace("-", "").Replace(" ", "").Replace("_", "");
            ...
            return ToDBC(pyString).ToLower().Replace("-", "").Replace(" ", "");
