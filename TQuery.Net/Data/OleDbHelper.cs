...
namespace TQuery.Net.Data
{
    public class OleDbHelper
    {
        ...
        public static DataSet GetPagingList(string connectionString, string primaryKey, string queryFields, string tableName, string condition, string orderBy, int pageSize, int pageIndex)
        {
        ...
        public static int GetRecordCount(string connectionString, string _ID, string _tbName, string _strCondition, int _Dist)
        {
            string sql = getPageListCounts(_ID, _tbName, _strCondition, _Dist);

            object obj = GetSingle(connectionString, sql);
            if (obj == null)
            {
                return 1;
            }
